          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900/90 rounded-2xl p-6 border border-blue-500">
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg transition-all mb-6"
              >
                + New Discussion
              </button>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  {['All Topics', 'Career Guidance', 'Technology', 'Medical', 'Engineering', 'Arts & Humanities', 'Science', 'Study Tips'].map(category => (
                    <button
                      key={category}
                      className="block w-full text-left text-gray-300 hover:text-blue-400 py-2 px-3 rounded-lg hover:bg-blue-900/30 transition-colors"
                    >
                      {category}
                    </button>
                  ))}
